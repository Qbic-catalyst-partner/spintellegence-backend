...
router.post('/', async (req, res) => {
    ...
    try {
        ...
        // Convert org_mapping to array if it's a string (comma-separated)
        ...
        const query = `
            INSERT INTO consultants(
                consultant_id, first_name, last_name, org_mapping, email, phone, role, status, consultant_organisation_name
